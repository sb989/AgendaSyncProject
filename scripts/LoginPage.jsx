      ...
      <div className="landingPage">
        <div className="splash">
          <div className="panel">
            ...
            <img className="splash-panel-image logo" src="https://dewey.tailorbrands.com/production/brand_version_mockup_image/304/4167981304_a6db7ea3-9908-4d0b-b315-1ed7c9167b14.png?cb=1605992586" alt="" />
            <div href="#section1" className="splash-panel-image subtitle">
              We&apos;ve got you in sync!
            </div>
            <div className="splash-panel-image-tag-line" />
          </div>
        </div>
        ...
        <div className="agenda">
          ...
          <div className="panel agenda-panels brand-halo">
            <p className="brand-halo-text pane-text">
              We&apos;re more than just an agenda application.
              <br className="hide-xs" />
              We reinvented the traditional task app.
              <strong>We are AgendaSync!</strong>
            </p>
            <img src="https://icons-for-free.com/iconfiles/png/512/note+notepad+icon-1320183464225485738.png" className="brand-halo-left-image" alt="" />

          </div>
          <div className="panel agenda-panels computing-power">
            <img className="panel-image-overlay" src="https://images.unsplash.com/photo-1577394732330-38cef75bc388?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80" alt="" />
            <div className="panel-overlay">
              <div className="computing-power-text-pane center-pane">
                <p className="computing-power-text pane-text">
                  We integrate more than just a
          ...
          <div className="panel agenda-panels hardware-software">
            <p className="hardware-software-text pane text-pane pane-text">
              AgendaSync is
              <strong> more</strong>
              <br />
              {' '}
            ...
            <div className="pane">
              <img className="pane-image" src="https://images.unsplash.com/photo-1474377207190-a7d8b3334068?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80" alt="" />
            </div>
          </div>
          <div className="panel agenda-panels game-changing">
            <img className="panel-image-overlay" src="https://images.unsplash.com/photo-1523634921619-37ce98c1877f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1952&q=80" alt="" />
            <div className="panel-overlay">
              <div className="game-changing-text-pane">
                <p className="game-changing-text pane-text" style={{ fontSize: '100px' }} />
                We have collectively used APIs,
                chatbot functionality, ReactJS, Python,
                and to-do list functionalities.
                <br />
                <br />
              </div>
            </div>
        ...
        <div className="people">
          ...
          <div className="panel people-panels software-people">
            <img className="panel-image-overlay" src="https://images.unsplash.com/photo-1573166801077-d98391a43199?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1949&q=80" alt="" />
            <div className="panel-overlay">
              <div className="software-people-text-pane">
                <p className="software-people-text pane-text">
                  Surindra Boodhoo, Jason Eccles,
                  Zaafira Hasan, and Andre Pugliese
                  are four NJIT students
                  <br />
                  {' '}
                  on a mission to bring you...
                </p>
              </div>
            </div>
          </div>
          <div className="panel people-panels panel-header core-competencies-panel">
            <p className="core-competencies-text pane-text white-text">
              An agenda application
              <br />
              {' '}
              <strong>like no other!</strong>
              {' '}
            </p>
          </div>
          <div className="panel people-panels thumbs-up-panel">
            <img className="panel-image-overlay" src="https://images.unsplash.com/photo-1602526430780-782d6b1783fa?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80" alt="" />
          </div>
        ...
        <div className="culture">
          ...
          <div className="panel culture-panels societal-contribution">
            <div className="societal-contributions-text-pane">
              <p className="societal-contributions-text pane-text">
                We wanted to bring an application that is unlike anything seen
                <strong>in the app store today.</strong>
              </p>
            </div>
          </div>
          <div className="panel culture-panels gavin-panel">
            <img className="panel-image-overlay" src="https://images.unsplash.com/photo-1538673719418-0367029d6f2e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2034&q=80" alt="" />

          </div>
          <div className="panel culture-panels state-of-the-art-facilities">
            <p className="state-of-the-art-facilities-text pane text-pane pane-text">
              Our application allows you to see your
              <strong>personalized Google calendar</strong>
              {' '}
              alongside a taskboard.
            </p>
            <div className="pane">
              <img className="pane-image" src="https://images.unsplash.com/photo-1600783245563-16114264a2c8?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1567&q=80" alt="" />
            </div>
          </div>
          <div className="panel culture-panels break-down-walls">
            <img className="panel-image-overlay" src="https://images.unsplash.com/photo-1544377165-d1859f53175f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1977&q=80" alt="" />
            <div className="panel-overlay">
              <div className="break-down-walls-text-pane">
                <p className="break-down-walls-text pane-text" style={{ color: 'grey' }}>
                  That lame Agenda. app doesn&apos;t let you
                  <br />
                  {' '}
                  <strong> sync </strong>
        ...
        <div className="mission">
          <div className="mission-panels panel-header">
            <img src="https://cdn3.iconfinder.com/data/icons/small/512/house_key_lock_property_security-128.png" alt="" />
          </div>
          <div className="panel mission-panels changing-the-world">
            <img className="panel-image-overlay" src="https://images.unsplash.com/photo-1468276311594-df7cb65d8df6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80" alt="" />
            <div className="panel-overlay">
              <div className="changing-the-world-text-pane">
                <p className="changing-the-world-text pane-text">
                  <span>
                    There are seperate apps that show Google calendars and taskboards,
                    <br />
                    {' '}
                    but none to bring these
                    <strong>two useful functionalities TOGETHER</strong>
                    !
                  </span>
                </p>
              </div>
          ...
          <div className="panel mission-panels bigger-than-our-innovations">
            <img className="panel-image-overlay" src="https://images.unsplash.com/photo-1567177662154-dfeb4c93b6ae?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80" alt="" />
            <div className="panel-overlay">
              <div className="bigger-than-our-innovations-text-pane center-pane">
                <p className="bigger-than-our-innovations-text pane-text">
                  This is where AgendaSync comes in as it
                  <strong>functions</strong>
                  {' '}
                  as both a calendar application, as well as a task board!
                </p>
              </div>
            </div>
          </div>
          <div className="panel missions-panels collective-accolades">
            <img className="panel-image-overlay" src="https://images.unsplash.com/photo-1443397646383-16272048780e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1567&q=80" alt="" />
            <div className="panel-overlay">
              <div className="collective-accolades-text-pane">
                <p className="collective-accolades-text pane-text">
                  You can add events to your personalized Google calendar, as well as
